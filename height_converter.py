...
ft_lable = Label(window, text= 'Feet', bg = 'purple', fg ='white',width= 14)
ft_lable.grid(column = 0,row = 0,padx = 15, pady = 15)
...
mt_lable = Label(window, text= 'Meter', bg = 'brown', fg ='white',width= 14)
mt_lable.grid(column = 0,row = 1)
